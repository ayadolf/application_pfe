...
class ChallengeDetailsScreen2 extends StatefulWidget {
  final String title;
  final String date;
  final String amount;

  const ChallengeDetailsScreen2({
    Key? key,
    required this.title,
    required this.date,
...
class _ChallengeDetailsScreenState extends State<ChallengeDetailsScreen2> {
