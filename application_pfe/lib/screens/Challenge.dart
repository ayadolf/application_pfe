...
import 'ChallengeDetailsScreen2.dart';
import 'ChallengeDetailsScreen3.dart';
        ...
        appBar: AppBar(
          ...
          leading:IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Dashboard()), // Remplacez DashboardPage par le nom de votre page de tableau de bord
              );
            },
            icon: Icon(
              Icons.arrow_back,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChallengeDetailsScreen1(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChallengeDetailsScreen2(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChallengeDetailsScreen3(
